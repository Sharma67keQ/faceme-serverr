...
export default function GroupScreen() {
  ...
  if (isLoading) {
    return (
      <Screen>
        <ScreenState variant="loading" title="Opening group" message="Group details are loading." />
      </Screen>
    );
  }
    ...
    return (
      <Screen>
        <ScreenState
          ...
          message="This group is unavailable right now."
          actionLabel="Retry"
  ...
  return (
    <Screen scroll>
      ...
      <View style={styles.list}>
        {arePostsLoading ? <ScreenState variant="loading" title="Loading posts" message="Fetching the latest group discussion." /> : null}
        {arePostsError ? (
          <ScreenState
            variant="error"
            title="Posts unavailable"
            message="We could not load this group's posts."
            actionLabel="Retry"
        ...
        {!arePostsLoading && !arePostsError && !posts.length ? (
          <ScreenState variant="empty" title="No posts visible yet" message="New group posts will appear here." />
        ) : null}
      </View>
    </Screen>
  );
